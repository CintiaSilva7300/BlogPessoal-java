...
public class UsuarioControllerTest {
	...
	void start(){
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Root", "root@rooot.com", "rootRoot","img.png"));
	}

	@Test
	@DisplayName("Cadastra um usuario")
	private void deveCriarUmUsuario() {
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>
		(new Usuario (0L, "Cintia", "cintia@rooot.com", "9root1234","img.png"));
